...
func (ctrl *Controller) GetProfile(ctx context.Context, req *desc.GetProfileRequest) (*desc.GetProfileResponse, error) {
	const op = "GetProfile"
	...
	profileDTO, err := ctrl.testingFacade.Profile.FindOneByID(ctx, id, nil, nil)
	if err != nil {
	...
	return &desc.GetProfileResponse{
