...
import (
	"github.com/neurochar/backend/internal/delivery/grpc/backend/mapper/helpers"
	...
	crmv1 "github.com/neurochar/backend/pkg/proto_pb/public/crm/v1"
)
...
func CandidateDTOToPb(item *crmUC.CandidateDTO) *crmv1.Candidate {
	if item == nil {
		return nil
	}

	resp := &crmv1.Candidate{
