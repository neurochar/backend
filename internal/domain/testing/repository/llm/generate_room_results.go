...
Резюме может влиять на итоговое решение hire / hire_with_conditions / do_not_hire только как дополнительный фактор после расчета personality_fit.score.
...
* допускается снижение confidence_score;
...
Дополнительное правило confidence_score:

Если опыт, достижения или заявленные качества в резюме существенно противоречат психометрическому профилю кандидата, снизь confidence_score на 0.05–0.20 в зависимости от степени противоречия.
...
key_matches — только действительно сильные совпадения между требованиями вакансии и психометрическим профилем. Разрешается усиливать выводы фактами из резюме.

key_gaps — только значимые расхождения между требованиями вакансии и психометрическим профилем.

risks — конкретные поведенческие риски на рабочем месте. При наличии релевантного опыта из резюме допускается указывать факторы, которые могут частично снижать риск.

action_items — практические вопросы и проверки для интервью, основанные на психометрическом профиле и, при наличии, опыте из резюме.
